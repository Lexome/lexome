/*
  ...
  - The values [narration] on the enum `EnhancementType` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "EnhancementType_new" AS ENUM ('summary', 'SUMMARY', 'NOTES', 'NARRATION');
